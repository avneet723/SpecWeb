        ...
        <section class="span6">
          ...
          <form method="post" action="./contactus_form_send.php">
            ...
            <div class="control-group">
              ...
              <div class="controls controls-row">
                <input type="text" class="input-xxlarge" id="subject" placeholder="What's up?">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls controls-row">
                <input type="text" class="input-xxlarge" id="message" placeholder="Please enter your message">
              </div>
            </div>
